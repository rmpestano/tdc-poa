...
public final class Crud<T extends Serializable> implements Serializable
{
   ...
   /**
    *
    * @return an unique entry from table represented by {@link com.tdc.poa.crud.Crud#persistentClass}
    * based on current com.tdc.poa.crudCrud#criteria and its restrictions
    * @throws javax.persistence.NonUniqueResultException in case current {@link com.tdc.poa.crud.Crud#criteria} doesn't match an unique entry
    */
   public T find()
   {
   ...
   /**
    *
    * @return all entries from the table represented by {@link com.tdc.poa.crud.Crud#persistentClass}
    * based on current {@link com.tdc.poa.crud.Crud#criteria} and its restrictions
    */
   public List<T> list()
   {
   ...
   /**
    *
    * @return all entries from table represented by {@link com.tdc.poa.crud.Crud#persistentClass}
    */
   ...
   /**
    *
    * @return number of entries from table represented by {@link com.tdc.poa.crud.Crud#persistentClass}
    * based on current @link{ com.tdc.poa.crud.Crud#criteria} and its restrictions
    */
   public int count()
   {
